...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        <div class="layui-input-block">
            <button class="layui-btn layui-btn-lg" lay-submit="" lay-filter="addOrUpdateSaleChancePage">确认</button>
            <button class="layui-btn layui-btn-lg layui-btn-normal" id="closerBtn">取消</button>
        </div>
    </div>
</form>
